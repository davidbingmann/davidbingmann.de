export const projects = [
  {
    ...
    body: [
      ...
      "Then there's how it feels. Dragging a card should feel physical. Colors should carry meaning, so you recognize a module at a glance and a card turns redder as its deadline approaches. None of that mattered while I was the only one using it, but it's the reason I open the app every morning without thinking twice.",
  ...
  },
  {
    ...
    body: [
      ...
      'While experimenting, I realized something obvious: speaking is the quickest way to get ideas out of your head. When you talk, your thoughts flow freely. When you type, you keep slowing down and losing your train of thought.',
  ...
  },
  {
    ...
    body: [
      'I wrote this paper for a seminar at the University of Trier. It looks at humanoid robots in the context of Industry 5.0, not as a replacement for people, but as a way to make industrial work more resilient, flexible and human-centered.',
